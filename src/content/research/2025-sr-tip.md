---
title:
  zh: High‑Fidelity Seismic Super‑Resolution Using Prior‑Informed Deep Learning with
    3D Awareness
  en: High‑Fidelity Seismic Super‑Resolution Using Prior‑Informed Deep Learning with
    3D Awareness
summary:
  zh: Prior-informed deep learning with 3D awareness for high-fidelity seismic super-resolution
    in realistic field data.
  en: Prior-informed deep learning with 3D awareness for high-fidelity seismic super-resolution
    in realistic field data.
progress:
  zh: "<b>Li, J.</b>, Wu, X., Zhang, X., Du, X., Sun, X., Deng, B. and Wang, G., 2025.
    High‑Fidelity Seismic Super‑Resolution Using Prior‑Informed Deep Learning with
    3D Awareness. IEEE Transactions on Image Processing. "
  en: "<b>Li, J.</b>, Wu, X., Zhang, X., Du, X., Sun, X., Deng, B. and Wang, G., 2025.
    High‑Fidelity Seismic Super‑Resolution Using Prior‑Informed Deep Learning with
    3D Awareness. IEEE Transactions on Image Processing. "
order: 102
visible: true
...
imageAlt:
  ...
  en: High‑Fidelity Seismic Super‑Resolution Using Prior‑Informed Deep Learning with
    3D Awareness
tags:
- zh: Seismic Super-Resolution
  en: Seismic Super-Resolution
- zh: Prior-Informed Learning
  en: Prior-Informed Learning
- zh: 3D Awareness
  en: 3D Awareness
links:
- label: Paper
  href: https://ieeexplore.ieee.org/document/11399639
- label: PDF
  href: "/files/pubs/li2026tip-sr.pdf"
---
