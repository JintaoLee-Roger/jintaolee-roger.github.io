---
title:
  zh: Memory-Efficient Full-Volume Inference for Large-Scale 3D Dense Prediction without
    Performance Degradation
  en: Memory-Efficient Full-Volume Inference for Large-Scale 3D Dense Prediction without
    Performance Degradation
summary:
  zh: Retraining-free operator-level optimization for memory-efficient full-volume
    inference in large-scale 3D dense prediction.
  en: Retraining-free operator-level optimization for memory-efficient full-volume
    inference in large-scale 3D dense prediction.
progress:
  zh: '<b>Li, J.</b> and Wu, X., 2026. Memory-Efficient Full-Volume Inference for
    Large-Scale 3D Dense Prediction without Performance Degradation. <b>Communications
    Engineering</b>. <br>(This paper was unanimously recognized by all three named
    reviewers: <a href="https://mts-commseng.nature.com/commseng_files/2025/11/26/00002959/02/2959_2_tpr_0_t69g1p_convrt.pdf">Peer
    Review File</a>)'
  en: '<b>Li, J.</b> and Wu, X., 2026. Memory-Efficient Full-Volume Inference for
    Large-Scale 3D Dense Prediction without Performance Degradation. <b>Communications
    Engineering</b>. <br>(This paper was unanimously recognized by all three named
    reviewers: <a href="https://mts-commseng.nature.com/commseng_files/2025/11/26/00002959/02/2959_2_tpr_0_t69g1p_convrt.pdf">Peer
    Review File</a>)'
...
imageAlt:
  ...
  en: Memory-Efficient Full-Volume Inference for Large-Scale 3D Dense Prediction without
    Performance Degradation
tags:
- zh: 3D Dense Prediction
  en: 3D Dense Prediction
- zh: Inference Efficiency
  en: Inference Efficiency
- zh: Operator Optimization
  en: Operator Optimization
links:
- label: Paper
  href: https://doi.org/10.1038/s44172-025-00576-2
- label: PDF
  href: "/files/pubs/li26infer_ce.pdf"
- label: Code
  href: https://github.com/JintaoLee-Roger/torchseis
- label: Supp
  href: https://static-content.springer.com/esm/art%3A10.1038%2Fs44172-025-00576-2/MediaObjects/44172_2025_576_MOESM2_ESM.pdf
---
